...
var routedComponents = [_sub_sub_component__WEBPACK_IMPORTED_MODULE_3__["SubComponent"]];
...
var AppComponent = /** @class */ (function () {
    function AppComponent(route, router, analyticsService) {
        this.route = route;
        this.router = router;
    ...
    AppComponent.prototype.setUserId = function () {
    ...
    AppComponent.prototype.showSub = function () {
...
var SubComponent = /** @class */ (function () {
    function SubComponent(analyticsService) {
        this.analyticsService = analyticsService;
        this.userId = this.analyticsService.userId;
    }
    SubComponent.prototype.ngOnInit = function () {
    };
    SubComponent.prototype.sendSub = function () {
    ...
    SubComponent.ctorParameters = function () { return [
